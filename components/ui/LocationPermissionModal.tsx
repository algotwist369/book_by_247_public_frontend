                ...
                <div className="p-8 sm:p-10 text-center space-y-6">
                    ...
                    <div className="flex justify-center">
                        <div className="relative">
                            <div className="w-20 h-20 rounded-full bg-zinc-50 flex items-center justify-center text-black">
                    ...
                    <div className="flex flex-col gap-3 py-2">
                        <div className="flex items-center gap-3 text-left px-4">
                            <div className="w-6 h-6 rounded-full bg-zinc-100 flex items-center justify-center text-black shrink-0">
                    ...
                    <div className="pt-2 space-y-3">
                        <Button
                            onClick={onAllow}
                            disabled={isLocating}
                            className="w-full h-14 bg-black hover:bg-zinc-900 text-white font-black text-lg rounded-2xl shadow-lg shadow-black/20 gap-2"
                        >
