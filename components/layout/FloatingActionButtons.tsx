...
export const FloatingActionButtons = () => {
    return (
        <div className="hidden md:flex fixed right-0 top-1/2 -translate-y-1/2 z-50 flex-col gap-2 pointer-events-none">
            ...
            <Link
                href="/book-demo"
                className="pointer-events-auto bg-zinc-800 text-white flex flex-col items-center gap-2 md:gap-4 py-4 px-2 md:py-6 md:px-3 rounded-l-xl md:rounded-l-2xl transition-colors hover:bg-zinc-700"
            >
