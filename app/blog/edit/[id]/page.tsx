...
import { useState, type FormEvent, useEffect, useRef, use } from "react"
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            if (blogRes?.data) {
                ...
                setVisibility((b.visibility as any) || "public")
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex justify-end pt-4">
                                    <button
                                        ...
                                        disabled={deleting}
                                        className="flex items-center gap-1.5 rounded-lg border border-red-200 bg-red-50 px-4 py-2 text-xs font-semibold text-red-700 hover:bg-red-100 disabled:opacity-50 transition-colors"
                                    >
